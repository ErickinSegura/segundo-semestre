...
int main() {
    ...
    Shapes.push_back(new triangulo(1,2,3,4));
    Shapes.push_back(new poligono(1,2,6,4,8));
    Shapes.push_back(new circulo(1,4,7));
    Shapes.push_back(new cuadrado(4,7,3));



    for (vector<shape*>::const_iterator i = Shapes.begin(); i != Shapes.end(); i++){
        cout<<"Figura: "<<(*i)->draw()<<endl;
